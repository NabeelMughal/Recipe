        ...
        <section className="bg-[#FFEEE7] p-5 rounded-xl shadow-md border border-[#E0AB8B]/40 overflow-x-hidden">
          ...
          <div className="mt-3 flex gap-2">
            ...
            <button
              ...
              className="bg-[#E0AB8B] cursor-pointer text-white hover:bg-[#c89273] px-3 rounded-md transition"
            >
              Add
            </button>
          </div>
        ...
        <section className="bg-[#FFEEE7] p-5 rounded-xl shadow-md border border-[#E0AB8B]/40 overflow-x-hidden">
          ...
          <div className="mt-3 flex gap-2">
            ...
            <button
              ...
              className="bg-[#E0AB8B] cursor-pointer text-white hover:bg-[#c89273] rounded-md transition h-fit px-3 py-2"
            >
              Add
            </button>
          </div>
