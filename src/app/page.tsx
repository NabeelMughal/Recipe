      ...
      <div className="relative max-w-2xl mx-auto">
        <header className="flex justify-between items-center mb-6">
           ...
           <button 
               ...
               className="bg-gradient-to-br from-[#fff2ea] to-[#f6d4c4] px-4 py-2 rounded-md flex items-center justify-center gap-2 bg-transparent border border-[#c97c54] text-[#c97c54] text-sm font-semibold hover:bg-[#c97c54] hover:text-white transition-colors"
           >
        ...
        >
          ...
          <button
            type="submit"
            className="px-4 py-2 rounded-md text-white bg-gradient-to-r from-[#E0AB8B] to-[#c97c54] text-sm font-semibold shadow-md hover:scale-105 transition-transform"
          >
            Add
          </button>
        </form>
